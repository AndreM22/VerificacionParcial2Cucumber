...
public class StepClean {
    ...
    public void yoUsoLaAuthenticacion(String type) {
    ...
    public void envioRequestALaURLConElBody(String method,String url,String body) {
    ...
    public void guardoElAtributoDeLaRespuestaEnUnaVariable(String attribute,String nameVariable) {
        dynamicVar.put(nameVariable,response.then().extract().path(attribute)+"");
    }

    @And("el atributo {} deberia ser {}")
    public void elAtributoDeberiaSer(String attribute,String expectedValue) {
        response.then()
